...
local function HandleInspectResult(unit, specID, iLv)
    if unit == "COMPLETE" then mppe.RefreshPartyInfo("HandleInspectResult-COMPLETE:"..unit) return end
    ...
    C_Timer.After(0.5, function() mppe.RefreshPartyInfo("HandleInspectResult-End") end) 
end
...
function pe:LOR_UnitCallback(unitId, unitInfo, allUnitsInfo)
    ...
    mppe.RefreshPartyInfo("LOR_UnitCallback-End")
end
...
function pe:LOR_GearCallback(unitId, gearInfo, allGear)
    ...
    C_Timer.After(0.5, function() mppe.RefreshPartyInfo("LOR_GearCallback-End") end) 
end
...
function pe:LOR_KeystoneCallback(unitName, keystoneInfo, allKeystones)
    ...
    --C_Timer.After(0.5, function() mppe.RefreshPartyInfo("LOR_KeystoneCallback-End") end) 
    C_Timer.After(0.5, function() mppe.RefreshPartyInfo() end) 
end
...
function pe:MPPE_GetPartyBestRuns(fullName)
    ...
    if _playerMythicPlusRatingSummary then
        ...
        C_Timer.After(0.5, function() mppe.RefreshPartyInfo("MPPE_GetPartyBestRuns-End") end) 
    end
end
